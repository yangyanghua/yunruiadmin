...
(function () {
    ...
    var httpService;
    if (currentHost == 'localhost:8383' || currentHost == '192.168.9.243:8081'|| currentHost=='zcode.admin:8080') {
            httpService = 'http://192.168.9.190:8090/';//开发环境
        }else if (currentHost=='tnewzzm.z-code.cn:8383/' || currentHost=='192.168.5.55' || currentHost=='tapp-admin-web.z-code.cn:8383') {/**测试环境**/
        httpService = 'http://tapp-admin-api.z-code.cn:8383/';
      }
    //   window.UMEDITOR_HOME_URL = httpService;
    ...
    window.UMEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:httpService+"information/uploadBig"             //图片上传提交地址
        // ,imagePath:httpService + "php/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        ...
        ,toolbar:[
            ...
            '| horizontal print preview fullscreen', 'drafts', 'formula','addUploadImg','addUploadVideo'
        ]
